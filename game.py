...
win.title("PUZZLE")
win.geometry(f"{WIDTH}x{HEIGHT+32}+500+200")
...
solve_b = Button(ribbon, text="💡", command=lambda: solve(num_turtle2), bd=0, bg="#BA8C63", font="bold",)
...
solve_b.place(relx=0.1, rely=0)
newgame_b.place(relx=0.2, rely=0)
exit_b.place(relx=0.9, rely=0)
